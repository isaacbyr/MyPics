...
router.get('/:id/profile', async (req, res) => {
  ...
  if (!req.user) {
    var currentUser_id = 'no current user'
    console.log(currentUser_id)
  } else {
    var currentUser_id = req.user._id
    console.log(currentUser_id)
  }
  console.log(user._id)

  res.render('users/profile', { user, photos, currentUser_id })
})
...
router.get('/:id/locations', async (req, res) => {
  ...
  res.render('users/locations', { user, photos })
})
